...
//        .def_readwrite("cur_event", &GameContext::curEvent) // todo standardize event names
    ...
    pybind11::enum_<PlayerStatus>(m, "PlayerStatus")
        ...
        .value("BLASPHEMY", PlayerStatus::BLASPHEMY)
        ...
        .value("EXTRA_TURN", PlayerStatus::EXTRA_TURN)
        ...
        .value("DEVA_FORM", PlayerStatus::DEVA_FORM)
        ...
        .value("NIRVANA", PlayerStatus::NIRVANA)
        ...
        .value("RUSHDOWN", PlayerStatus::RUSHDOWN)
        ...
        .value("RETAIN_CARDS", PlayerStatus::RETAIN_CARDS);
    ...
    pybind11::enum_<Stance>(m, "Stance")
    ...
    pybind11::enum_<Orb>(m, "Orb")
        .value("EMPTY", Orb::EMPTY)
        .value("DARK", Orb::DARK)
        .value("FROST", Orb::FROST)
        .value("PLASMA", Orb::PLASMA)
        .value("LIGHTNING", Orb::LIGHTNING);
